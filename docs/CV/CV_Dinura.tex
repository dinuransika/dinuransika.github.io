...
\begin{center}
    ...
    % \href{https://dinuransika.github.io}{\raisebox{-0.2\height} \underline{dinuransika.github.io}} \\ \vspace{1pt}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {BSc Engineering (Hons) | Faculty of Engineering }{GPA - 3.77 / 4.0}
      \resumeSubheading
    ...
    \resumeProjectHeading
      ...
      \resumeProjectHeading
        ...
        in Cool programming language.}
          ...
          \vspace{-13pt}
          \resumeProjectHeading
          {\textbf{Image Processing techniques to detect damaged fruit} $|$ \emph{Group Project}}{2019}
          \resumeItemListStart
            \resumeItem{Image Filtering with OpenCV was used to create an algorithm to detect the deformities of fruit. Created application using python to continuously monitor given set of images.}
            \resumeItem{Technologies - Python, OpenCV, Kanny, Sobel}
           \resumeItem{\underline{\href{https://github.com/GroupCaliber/FreshnessMeter}{Project Repository Link}}}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
\vspace{-10pt}
